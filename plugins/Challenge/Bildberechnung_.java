...
public class Bildberechnung_ extends ImagePlus implements PlugIn {
...
static File dir;
	...
	void saveData(String text, String filename) {
		...
		//for(int i = 0; i<clean_coords_array.length; i++){
		//	text = text + clean_coords_array[i] + "\n";
		//}
